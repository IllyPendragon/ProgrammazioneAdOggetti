...
/**
 * Classe che definisce StatsCompetitions
 * 
 */
public class StatsCompetitions {
	...
	/**
	 * Variabile che descrive il numero delle competizioni
	 */
	private Long numCompetions = null;
	/**
	 * Variabile che descrive la durata media delle competizioni
	 */
	private Long averageDuration = null;
	/**
	 * Variabile che descrive il numero minimo delle squadre delle competizioni
	 */
	private Long minNumberTeams = null;
	/**
	 * Variabile che descrive il numero massimo delle squadre delle competizioni
	 */
	...
	/**
	 * Variabile che descrive il numero medio delle stagioni disponibili
	 */
	private Long numberAverageOfAvailableSeasons = null;
	
	
	/**
	 * @return the numCompetions
	 */
	public Long getNumCompetions() {
		return numCompetions;
	}
	/**
	 * @param numCompetions the numCompetions to set
	 */
